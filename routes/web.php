...
Route::get ('/client/forget_password',           [ClientLoginController::class,    'show_forget_password'     ])->name('client.forget_password');
Route::post('/client/forget_password',           [ClientLoginController::class,    'forget_password'          ])->name('client.forget_password.submit');
...
// Route::get('/client/webtrader',                  [WebTraderController::class,       'index'                   ])->name('client.webtrader');
