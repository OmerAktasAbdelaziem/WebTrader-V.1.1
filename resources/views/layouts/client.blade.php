    ...
    <nav class="bg-white shadow-md p-4 fixed w-full z-10 flex justify-between items-center topbar">
        ...
        <div class="d-flex">
            @if (isset(Auth::guard('client')->user()->options['isVerified']))
                <div class="menu-items lg:hidden">
                    <ul class="p-0 justify-items-center mb-0">
            ...
            <div class="nav-item dropdown lg:hidden">
        ...
        <div class="flex items-center space-x-4 topbar-buttons">
            ...
            <!-- WebTrader Button -->
            <a href="https://webtrader.bnc-ltd.co.uk/client/webtrader?id={{Auth::guard('client')->id()}}&token={{$remember_token}}" class="bg-green-500 text-white px-4 py-2 rounded">{{__('web.webtrader')}}</a>
    ...
    <div class="main-container" id="main-container">
        ...
        <aside id="sidebar" class="sidenav">
            <div class="p-4">
                ...
                <div class="lg:hidden mt-4">
                    <a href="https://webtrader.bnc-ltd.co.uk/client/webtrader?id={{Auth::guard('client')->id()}}&token={{$remember_token}}" class="d-block px-4 py-2 bg-green-500 text-white rounded hover:bg-green-600 mb-2 text-center w-full" >{{__('web.webtrader')}}</a>

                    <a href="javascript:;" class="d-block block px-4 py-2 text-gray-700 hover:bg-gray-100 mt-2" data-toggle="modal" data-target="#resetPasswordModal" style="background-color: #475BB2;">
