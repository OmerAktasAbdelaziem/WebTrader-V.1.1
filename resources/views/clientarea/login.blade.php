    ...
    <div class="w-full max-w-md bg-white shadow-lg rounded-lg overflow-hidden">
        ...
        <div class="px-6 py-4">
            ...
            <form method="POST" action="{{ route('client.login') }}">
                ...
                <a style="color: rgb(31, 121, 238);" href="{{route ('client.signup')}}">{{ __('web.create_new_account') }}</a><br>
                <a style="color: rgb(246, 42, 42);" href="{{route ('client.forget_password')}}">{{ __('web.reset_password') }}</a>
            </form>
        </div>
